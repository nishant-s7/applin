        ...
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <form class="w-full max-w-md">
                ...
                <div class="flex items-center justify-center mt-6">
                    <Link to="/login" class="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b-2  border-blue-500 dark:border-blue-400 dark:text-white dark:border-gray-400 dark:text-gray-300">
                        Sign in
                    </Link>
    
                    <Link to="/signup" class="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b border-blue-500 dark:border-blue-400 dark:text-white dark:border-gray-400 dark:text-gray-300">
                        Sign up
                    </Link>
                </div>
                ...
                <span class="absolute">
                    ...
                    <input type="phone" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Mobile Number" />
                </div>
